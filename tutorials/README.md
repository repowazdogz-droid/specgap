...
Step-by-step walkthroughs with verified commands and expected output. Run all commands from the `specgap/` directory (after `cd specgap` from the Omega repository root).

Assurance context: [`docs/SPECIFICATION.md`](../docs/SPECIFICATION.md), [`docs/TCB.md`](../docs/TCB.md), [`docs/ENCODING.md`](../docs/ENCODING.md).

## 10-minute path

1. [README Quick Start](../README.md#quick-start) — venv, install, headline demo
